"""addshipping_21603 URL Configuration
...
admin.site.site_header = "AddShipping"
admin.site.site_title = "AddShipping Admin Portal"
admin.site.index_title = "AddShipping Admin"

# swagger
api_info = openapi.Info(
    title="AddShipping API",
    default_version="v1",
    description="API documentation for AddShipping App",
)
